            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.$on("streamsUpdate", function (event, streams) {
                        ...
                        var wheelCount =
                            streams.tyrewearandthermals2.data.length;
                        function roundRect(
                            ctx,
                            x,
                            y,
                        ...
                        function drawWheelData(
                            ...
                            ctx.font =
                                'bold 18pt "Lucida Console", Monaco, monospace';
                            var conditionAverage =
                                condition_zones.reduce((a, b) => a + b, 0) /
                                condition_zones.length;
                            ctx.fillText(
                                "" + Math.floor(conditionAverage) + "%",
                                cx,
                                y - 8,
                            );
                            ...
                            for (let i = 0; i < condition_zones.length; i++) {
                                ...
                                var font_size = Math.max(
                                    Math.min(w / 20.0 * 3.0, 16.0),
                                    4.0,
                                );
                                ctx.font = "bold " + font_size +
                                    'pt "Lucida Console", Monaco, monospace';
                                if (i < 3) {
                                    let middleTemp = 0;
                            ...
                            var coreTempT = 1.0 -
                                Math.min(
                                    Math.max(
                                        temps[temps.length - 1] / working_temp -
                                            0.5,
                                        0,
                                    ),
                                    1,
                            ...
                            var coreHue = lowHue +
                                (highHue - lowHue) * coreTempT;
                            let coreTempIsDisplayed;
                            if (t < 0.1) {
                                coreTempIsDisplayed = 0;
                                ctx.fillStyle = "rgba(0,0,0,0.45)";
                            } else {
                                ctx.fillStyle = "hsla(" + coreHue +
                                    ",82%,56%,1)";
